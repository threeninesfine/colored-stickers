...
options( knitr.table.format = "latex",  # guarantees 'kableExtra' formatting handled properly
         knitr.kable.na = " - ")  # replaces NA entries with ' - ' in kable output
```
...
.col.names = c("n", "bZ", "bX", "Pr( Y )", "Pr( X )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.caption = "Binary Y, binary X: Coverage probability, n = 32";
.align = c(rep("c", 5), rep("r", 8));
.header.randomization.method = c(" " = 5, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method = c(" " = 5, "Model-based" = 6, "Rerandomization" = 2);
tbl1_coverage %>%
  # TODO(MICHAEL): format table with colors in .pdf, not HTML format (as below)!
  # mutate_if( is.numeric, function( x ){
  #   cell_spec( x, bold = TRUE,
  #             color = spec_color( x, end = 0.9 ),
  #             font_size =  spec_font_size( x ) )
  # }) %>%
kable( row.names = FALSE, col.names = .col.names, caption = .caption, align = .align, booktabs = TRUE) %>%
  kable_styling( latex_options = c("striped", "bordered", "hold_position"), full_width = FALSE ) %>%
...
.col.names = c("n", "bZ", "bX", "Pr( Y )", "Pr( X )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.caption = "Binary Y, binary X: Bias, n = 32";
.align = c(rep("c", 5), rep("r", 8));
.header.randomization.method = c(" " = 5, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method = c(" " = 5, "Model-based" = 6, "Rerandomization" = 2);
tbl1_bias %>%
...
.col.names = c("n", "bZ", "bX", "Pr( Y )", "Pr( X )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.caption = "Binary Y, binary X: Power, n = 32";
.align = c(rep("c", 5), rep("r", 8));
.header.randomization.method = c(" " = 5, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method = c(" " = 5, "Model-based" = 6, "Rerandomization" = 2);
tbl1_power %>%
...
.col.names = c("n", "bZ", "bX", "Pr( Y )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.caption = "Binary Y, continuous X: Coverage probability";
.align = c(rep("c", 4), rep("r", 8));
.header.randomization.method = c(" " = 4, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method = c(" " = 4, "Model-based" = 6, "Rerandomization" = 2);
tbl2_coverage %>%
  # TODO(MICHAEL): format table with colors in .pdf, not HTML format (as below)!
  # mutate_if( is.numeric, function( x ){
  #   cell_spec( x, bold = TRUE,
...
.col.names = c("n", "bZ", "bX", "Pr( Y )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.caption = "Binary Y, continuous X: Bias";
.align = c(rep("c", 4), rep("r", 8));
.header.randomization.method = c(" " = 4, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method = c(" " = 4, "Model-based" = 6, "Rerandomization" = 2);
tbl2_bias %>%
...
.col.names = c("n", "bZ", "bX", "Pr( Y )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.caption = "Binary Y, continuous X: Power";
.align = c(rep("c", 4), rep("r", 8));
.header.randomization.method = c(" " = 4, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method = c(" " = 4, "Model-based" = 6, "Rerandomization" = 2);
tbl2_power %>%
...
.col.names = c("n", "bZ", "bX", "Pr( X )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.caption = "Continuous Y, binary X: Coverage probability";
.align = c(rep("c", 4), rep("r", 8));
.header.randomization.method = c(" " = 4, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method = c(" " = 4, "Model-based" = 6, "Rerandomization" = 2);
tbl3_coverage %>%
...
.col.names = c("n", "bZ", "bX", "Pr( X )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.caption = "Continuous Y, binary X: Bias";
.align = c(rep("c", 4), rep("r", 8));
.header.randomization.method = c(" " = 4, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method = c(" " = 4, "Model-based" = 6, "Rerandomization" = 2);
tbl3_bias %>%
...
.col.names = c("n", "bZ", "bX", "Pr( X )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.caption = "Continuous Y, binary X: Power";
.align = c(rep("c", 4), rep("r", 8));
.header.randomization.method = c(" " = 4, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method = c(" " = 4, "Model-based" = 6, "Rerandomization" = 2);
tbl3_power %>%
...
.col.names = c("n", "bZ", "bX", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.caption = "Continuous Y, continuous X: Coverage probability";
.align = c(rep("c", 3), rep("r", 8));
.header.randomization.method = c(" " = 3, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method = c(" " = 3, "Model-based" = 6, "Rerandomization" = 2);
tbl4_coverage %>%
  # TODO(MICHAEL): format table with colors in .pdf, not HTML format (as below)!
  # mutate_if( is.numeric, function( x ){
  #   cell_spec( x, bold = TRUE,
...
.col.names = c("n", "bZ", "bX", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.caption = "Continuous Y, continuous X: Bias";
.align = c(rep("c", 3), rep("r", 8));
.header.randomization.method = c(" " = 3, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method = c(" " = 3, "Model-based" = 6, "Rerandomization" = 2);
tbl4_bias %>%
...
.col.names = c("n", "bZ", "bX", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.caption = "Continuous Y, continuous X: Power";
.align = c(rep("c", 3), rep("r", 8));
.header.randomization.method = c(" " = 3, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method = c(" " = 3, "Model-based" = 6, "Rerandomization" = 2);
tbl4_power %>%
