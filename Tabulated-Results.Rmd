...
kable( row.names = FALSE, col.names = .col.names, caption = .caption, align = .align, booktabs = TRUE) %>%
  kable_styling( latex_options = c("striped", "bordered"), full_width = FALSE ) %>%
  add_header_above(c(" " = 5, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2)) %>%
  add_header_above(c(" " = 5, "Model-based" = 6, "Rerandomization" = 2))
```
