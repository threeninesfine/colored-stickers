...
#' [ Batch 1 of 4: binary Y, binary X -- subsetted on draws without complete/quasi separation ]
metrics_bybx_sub <- read.csv(paste0( datadir_path, "metrics-subset-alloc-simulation-batch-1-of-4.csv" ))
#' [ Batch 2 of 4: binary Y, continuous X -- subsetted on draws without complete/quasi separation ]
...
<!-- BATCH 1 of 4, SUBSETTING ON VALID DRAWS --> 
```{r batch-1-subset-binY-binX_coverage, cache = TRUE, echo = FALSE}
#' Adjusted analysis
tbl1sub1_cov_adj <- subset( metrics_bybx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CR" & rerandomized == 0 & adjusted == 1 ) )
tbl1sub2_cov_adj <- subset( metrics_bybx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "SBR" & rerandomized == 0 & adjusted == 1 ) )
tbl1sub3_cov_adj <- subset( metrics_bybx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 0 & adjusted == 1 ) )
tbl1sub4_cov_adj <- subset( metrics_bybx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 1 & adjusted == 1 ) )
#' Unadjusted analysis
tbl1sub1_cov_un <- subset( metrics_bybx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CR" & rerandomized == 0 & adjusted == 0 ) )
tbl1sub2_cov_un <- subset( metrics_bybx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "SBR" & rerandomized == 0 & adjusted == 0 ) )
tbl1sub3_cov_un <- subset( metrics_bybx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 0 & adjusted == 0 ) )
tbl1sub4_cov_un <- subset( metrics_bybx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 1 & adjusted == 0 ) )
...
#' Adjusted analysis
tbl1sub1_bias_adj <- subset( metrics_bybx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CR" & rerandomized == 0 & adjusted == 1 ) )
tbl1sub2_bias_adj <- subset( metrics_bybx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "SBR" & rerandomized == 0 & adjusted == 1 ) )
tbl1sub3_bias_adj <- subset( metrics_bybx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 0 & adjusted == 1 ) )
tbl1sub4_bias_adj <- subset( metrics_bybx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 1 & adjusted == 1 ) )
#' Unadjusted analysis
tbl1sub1_bias_un <- subset( metrics_bybx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CR" & rerandomized == 0 & adjusted == 0 ) )
tbl1sub2_bias_un <- subset( metrics_bybx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "SBR" & rerandomized == 0 & adjusted == 0 ) )
tbl1sub3_bias_un <- subset( metrics_bybx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 0 & adjusted == 0 ) )
tbl1sub4_bias_un <- subset( metrics_bybx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 1 & adjusted == 0 ) )
...
#' Adjusted analysis
tbl1sub1_power_adj <- subset( metrics_bybx_sub, select = c( power.pvalue, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CR" & rerandomized == 0 & adjusted == 1 ) )
tbl1sub2_power_adj <- subset( metrics_bybx_sub, select = c( power.pvalue, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "SBR" & rerandomized == 0 & adjusted == 1 ) )
tbl1sub3_power_adj <- subset( metrics_bybx_sub, select = c( power.pvalue, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 0 & adjusted == 1 ) )
tbl1sub4_power_adj <- subset( metrics_bybx_sub, select = c( power.rerand, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 1 & adjusted == 1 ) )
#' Unadjusted analysis
tbl1sub1_power_un <- subset( metrics_bybx_sub, select = c( power.pvalue, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CR" & rerandomized == 0 & adjusted == 0 ) )
tbl1sub2_power_un <- subset( metrics_bybx_sub, select = c( power.pvalue, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "SBR" & rerandomized == 0 & adjusted == 0 ) )
tbl1sub3_power_un <- subset( metrics_bybx_sub, select = c( power.pvalue, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 0 & adjusted == 0 ) )
tbl1sub4_power_un <- subset( metrics_bybx_sub, select = c( power.rerand, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence, prognostic_factor_prevalence ),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 1 & adjusted == 0 ) )
...
<!-- BATCH 2 of 4, SUBSETTING ON VALID DRAWS -->
```{r batch-2-subset-binY-contX_coverage, cache = TRUE, echo = FALSE}
#' Adjusted analysis
tbl2sub1_cov_adj <- subset( metrics_bycx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CR" & rerandomized == 0 & adjusted == 1 ) )
tbl2sub2_cov_adj <- subset( metrics_bycx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "SBR" & rerandomized == 0 & adjusted == 1 ) )
tbl2sub3_cov_adj <- subset( metrics_bycx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 0 & adjusted == 1 ) )
tbl2sub4_cov_adj <- subset( metrics_bycx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 1 & adjusted == 1 ) )
#' Unadjusted analysis
tbl2sub1_cov_un <- subset( metrics_bycx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CR" & rerandomized == 0 & adjusted == 0 ) )
tbl2sub2_cov_un <- subset( metrics_bycx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "SBR" & rerandomized == 0 & adjusted == 0 ) )
tbl2sub3_cov_un <- subset( metrics_bycx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 0 & adjusted == 0 ) )
tbl2sub4_cov_un <- subset( metrics_bycx_sub, select = c( coverage, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 1 & adjusted == 0 ) )
...
#' Adjusted analysis
tbl2sub1_bias_adj <- subset( metrics_bycx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CR" & rerandomized == 0 & adjusted == 1 ) )
tbl2sub2_bias_adj <- subset( metrics_bycx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "SBR" & rerandomized == 0 & adjusted == 1 ) )
tbl2sub3_bias_adj <- subset( metrics_bycx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 0 & adjusted == 1 ) )
tbl2sub4_bias_adj <- subset( metrics_bycx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 1 & adjusted == 1 ) )
#' Unadjusted analysis
tbl2sub1_bias_un <- subset( metrics_bycx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CR" & rerandomized == 0 & adjusted == 0 ) )
tbl2sub2_bias_un <- subset( metrics_bycx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "SBR" & rerandomized == 0 & adjusted == 0 ) )
tbl2sub3_bias_un <- subset( metrics_bycx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 0 & adjusted == 0 ) )
tbl2sub4_bias_un <- subset( metrics_bycx_sub, select = c( bias, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 1 & adjusted == 0 ) )
...
#' Adjusted analysis
tbl2sub1_power_adj <- subset( metrics_bycx_sub, select = c( power.pvalue, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CR" & rerandomized == 0 & adjusted == 1 ) )
tbl2sub2_power_adj <- subset( metrics_bycx_sub, select = c( power.pvalue, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "SBR" & rerandomized == 0 & adjusted == 1 ) )
tbl2sub3_power_adj <- subset( metrics_bycx_sub, select = c( power.pvalue, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 0 & adjusted == 1 ) )
tbl2sub4_power_adj <- subset( metrics_bycx_sub, select = c( power.rerand, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 1 & adjusted == 1 ) )
#' Unadjusted analysis
tbl2sub1_power_un <- subset( metrics_bycx_sub, select = c( power.pvalue, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CR" & rerandomized == 0 & adjusted == 0 ) )
tbl2sub2_power_un <- subset( metrics_bycx_sub, select = c( power.pvalue, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "SBR" & rerandomized == 0 & adjusted == 0 ) )
tbl2sub3_power_un <- subset( metrics_bycx_sub, select = c( power.pvalue, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 0 & adjusted == 0 ) )
tbl2sub4_power_un <- subset( metrics_bycx_sub, select = c( power.rerand, trial_size, treatment_assignment_effect_size, prognostic_factor_effect_size, outcome_marginal_prevalence),
                          subset = ( alloc_method == "CAA-MI-2-PBA-0.70" & rerandomized == 1 & adjusted == 0 ) )
...
.col.names.b1 = c("n", "bZ", "bX", "Pr( Y )", "Pr( X )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.align.b1 = c(rep("c", 5), rep("r", 8));
.latex_options.b1 = c("striped", "bordered", "hold_position")
.header.randomization.method.b1 = c(" " = 5, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method.b1 = c(" " = 5, "Model-based" = 6, "Rerandomization" = 2);
.batch.label <- "Batch 1(a): Binary Y, binary X"
.batch.sublabels <- c("Coverage probability")
```

```{r batch-1-coverage-table, cache = TRUE, echo = FALSE, results='asis'}
tbl1_coverage %>%
kable( caption = "Binary Y, binary X: Coverage probability", row.names = FALSE, 
       col.names = .col.names.b1, align = .align.b1, booktabs = TRUE) %>%
...
tbl1_bias %>%
kable( caption = "Binary Y, binary X: Bias", row.names = FALSE, 
       col.names = .col.names.b1, align = .align.b1, booktabs = TRUE) %>%
  kable_styling( latex_options = .latex_options.b1, full_width = FALSE ) %>%
  add_header_above( .header.randomization.method.b1 ) %>%
  add_header_above( .header.analysis.method.b1 )
...
tbl1_power %>%
kable( caption = "Binary Y, binary X: Power", row.names = FALSE, 
       col.names = .col.names.b1, align = .align.b1, booktabs = TRUE) %>%
  kable_styling( latex_options = .latex_options.b1, full_width = FALSE ) %>%
  add_header_above( .header.randomization.method.b1 ) %>%
  add_header_above( .header.analysis.method.b1 )
...
\newpage
### Subsetted simulation results (draws without non-complete separation)
...
.col.names.b2 = c("n", "bZ", "bX", "Pr( Y )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.align.b2 = c(rep("c", 4), rep("r", 8));
.latex_options.b2 = c("striped", "bordered", "hold_position")
.header.randomization.method.b2 = c(" " = 4, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method.b2 = c(" " = 4, "Model-based" = 6, "Rerandomization" = 2);
```

### Complete simulation results (5010 simulation draws)
```{r batch-2-coverage-table, cache = TRUE, echo = FALSE, results='asis'}
tbl2_coverage %>%
kable( caption = "Binary Y, continuous X: Coverage probability", row.names = FALSE, 
       col.names = .col.names.b2, align = .align.b2, booktabs = TRUE) %>%
...
tbl2_bias %>%
kable( caption = "Binary Y, continuous X: Bias", row.names = FALSE, 
       col.names = .col.names.b2, align = .align.b2, booktabs = TRUE) %>%
  kable_styling( latex_options = .latex_options.b2, full_width = FALSE ) %>%
  add_header_above( .header.randomization.method.b2 ) %>%
  add_header_above( .header.analysis.method.b2 )
...
tbl2_power %>%
kable( caption = "Binary Y, continuous X: Power", row.names = FALSE, 
       col.names = .col.names.b2, align = .align.b2, booktabs = TRUE) %>%
  kable_styling( latex_options = .latex_options.b2, full_width = FALSE ) %>%
  add_header_above( .header.randomization.method.b2 ) %>%
  add_header_above( .header.analysis.method.b2 )
...
.col.names.b3 = c("n", "bZ", "bX", "Pr( X )", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.align.b3 = c(rep("c", 4), rep("r", 8));
.latex_options.b3 = c("striped", "bordered", "hold_position")
.header.randomization.method.b3 = c(" " = 4, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method.b3 = c(" " = 4, "Model-based" = 6, "Rerandomization" = 2);
```

```{r batch-3-coverage-table, cache = TRUE, echo = FALSE, results='asis'}
tbl3_coverage %>%
kable( caption = "Continuous Y, binary X: Coverage probability", row.names = FALSE, 
       col.names = .col.names.b3, align = .align.b3, booktabs = TRUE) %>%
...
tbl3_bias %>%
kable( caption = "Continuous Y, binary X: Bias", row.names = FALSE, 
       col.names = .col.names.b3, align = .align.b3, booktabs = TRUE) %>%
  kable_styling( latex_options = .latex_options.b3, full_width = FALSE ) %>%
  add_header_above( .header.randomization.method.b3 ) %>%
  add_header_above( .header.analysis.method.b3 )
...
tbl3_power %>%
kable( caption = "Continuous Y, binary X: Power", row.names = FALSE, 
       col.names = .col.names.b3, align = .align.b3, booktabs = TRUE) %>%
  kable_styling( latex_options = .latex_options.b3, full_width = FALSE ) %>%
  add_header_above( .header.randomization.method.b3 ) %>%
  add_header_above( .header.analysis.method.b3 )
...
.col.names.b4 = c("n", "bZ", "bX", "adj", "unadj", "adj", "unadj", "adj", "unadj", "adj", "unadj");
.align.b4 = c(rep("c", 3), rep("r", 8));
.latex_options.b4 = c("striped", "bordered", "hold_position");
.header.randomization.method.b4 = c(" " = 3, "CR" = 2, "SBR" = 2, "CAA" = 2, "CAA" = 2);
.header.analysis.method.b4 = c(" " = 3, "Model-based" = 6, "Rerandomization" = 2);
```

```{r batch-4-coverage-table, cache = TRUE, echo = FALSE, results='asis'}
tbl4_coverage %>%
kable( caption = "Continuous Y, continuous X: Coverage probability", row.names = FALSE, 
       col.names = .col.names.b4, align = .align.b4, booktabs = TRUE) %>%
...
tbl4_bias %>%
kable( caption = "Continuous Y, continuous X: Bias", row.names = FALSE, 
       col.names = .col.names.b4, align = .align.b4, booktabs = TRUE) %>%
  kable_styling( latex_options = .latex_options.b4, full_width = FALSE ) %>%
  add_header_above( .header.randomization.method.b4 ) %>%
  add_header_above( .header.analysis.method.b4 )
...
tbl4_power %>%
kable( caption = "Continuous Y, continuous X: Power", row.names = FALSE, 
       col.names = .col.names.b4, align = .align.b4, booktabs = TRUE) %>%
  kable_styling( latex_options = .latex_options.b4, full_width = FALSE ) %>%
  add_header_above( .header.randomization.method.b4 ) %>%
  add_header_above( .header.analysis.method.b4 )
