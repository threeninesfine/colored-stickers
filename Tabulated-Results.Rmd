...
kable( tbl1_coverage, row.names = FALSE, caption = "Binary Y, binary X: Coverage probability, n = 32" )
```

\newpage
```{r batch-1-bias-table, cache = TRUE, echo = FALSE, results='asis'}
kable( tbl1_bias, row.names = FALSE, caption = "Binary Y, binary X: Bias, n = 32" )
```

\newpage
```{r batch-1-power-table, cache = TRUE, echo = FALSE, results='asis'}
kable( tbl1_power, row.names = FALSE, caption = "Binary Y, binary X: Power, n = 32" )
```
...
kable( tbl2_coverage, row.names = FALSE, caption = "Binary Y, continuous X: Coverage probability" )
```

\newpage
```{r batch-2-bias-table, cache = TRUE, echo = FALSE, results='asis'}
kable( tbl2_bias, row.names = FALSE, caption = "Binary Y, continuous X: Bias" )
```

\newpage
```{r batch-2-power-table, cache = TRUE, echo = FALSE, results='asis'}
kable( tbl2_power, row.names = FALSE, caption = "Binary Y, continuous X: Power" )
```
...
kable( tbl3_coverage, row.names = FALSE, caption = "Continuous Y, binary X: Coverage probability" )
```

\newpage
```{r batch-3-bias-table, cache = TRUE, echo = FALSE, results='asis'}
kable( tbl3_bias, row.names = FALSE, caption = "Continuous Y, binary X: Bias" )
```

\newpage
```{r batch-3-power-table, cache = TRUE, echo = FALSE, results='asis'}
kable( tbl3_power, row.names = FALSE, caption = "Continuous Y, binary X: Power" )
```
...
kable( tbl4_coverage, row.names = FALSE, caption = "Continuous Y, continuous X: Coverage probability" )
```

\newpage
```{r batch-4-bias-table, cache = TRUE, echo = FALSE, results='asis'}
kable( tbl4_bias, row.names = FALSE, caption = "Continuous Y, continuous X: Bias" )
```

\newpage
```{r batch-4-power-table, cache = TRUE, echo = FALSE, results='asis'}
kable( tbl4_power, row.names = FALSE, caption = "Continuous Y, continuous X: Power" )
```
